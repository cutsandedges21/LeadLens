    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600">Find answers, guides, and support for using LeadLens</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="border-slate-200 hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-slate-600">Watch step-by-step tutorials</p>
            </CardContent>
          </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {tutorials.map((tutorial, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-slate-600">{tutorial.duration}</p>
                </div>
              ))}
            </div>
          </CardContent>
